...
//MARK: - Adding Black View for animation
...
//MARK: - Adding an animation cancel button
...
//MARK: - Adding Full Image View for animation
...
//MARK: - Adding Extension UICollectionViewDataSource
extension PhotosViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.collectionImageView.image = UIImage(named: photos[indexPath.item].image)
        return cell
    }
}

//MARK: - Adding Extension UICollectionViewDelegateFlowLayout
...
// MARK: - Adding Extension PhotoCellDelegate
